/* »митируем действи€ пользовател€, который рандомно нажимает клавиши на контроллере, */
/* ћодель разрабатываетс€ дл€ того, чтобы проверить deadlock, livelock, starvation при таких действи€х */
...
/*  аждому состо€нию эквивалентна пара виджет + возможность действи€ (???). */
int state = 0;
